    ...
    <main className="pt-24 bg-[#f5f7f9] text-[#2c2f31]">
      ...
      <section className="px-6 md:px-16 py-28 max-w-6xl relative">
        ...
        <p className="mt-6 text-lg text-gray-600 max-w-2xl leading-relaxed">
          From catalog to conversions — we handle operations, growth, and performance so you can scale.
        </p>

        <div className="flex gap-8 mt-10 text-lg font-semibold">
          <Link href="/services/ecommerce" className="text-gray-400 hover:text-black transition">
            Explore E-commerce
          </Link>

          <Link href="/tools/ad-analyzer" className="text-black hover:underline">
            Try Free Tool
          </Link>
        </div>
        ...
        <div className="mt-14 bg-white rounded-2xl shadow-md p-6 max-w-3xl border border-gray-100">
          <h3 className="font-semibold text-lg mb-4">Growth Snapshot</h3>
      ...
      <section className="px-6 md:px-16 py-20 max-w-6xl">
        ...
        <div className="space-y-6">
          ...
          <Link href="/services/ecommerce" className="block bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition">
            <h3 className="text-xl font-bold">E-commerce Growth</h3>
            <p className="text-gray-500 mt-2">Catalog, ads, scaling systems</p>
          </Link>

          <Link href="/services/ad-marketing" className="block bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition">
            <h3 className="text-xl font-bold">Ad Marketing</h3>
            <p className="text-gray-500 mt-2">Performance campaigns & scaling</p>
          </Link>

          <div className="bg-white p-6 rounded-2xl shadow-sm">
            <h3 className="text-xl font-bold">SEO</h3>
            <p className="text-gray-500 mt-2">Rank & organic growth</p>
          </div>
